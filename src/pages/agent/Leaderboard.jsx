...
const Leaderboard = () => {
  ...
  return (
    <div className="p-5 md:p-6 lg:p-8 flex flex-col min-h-screen bg-slate-50">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 md:p-5 mb-5 flex flex-col md:flex-row md:items-center md:justify-between gap-3 max-w-[850px]">
        <div>
              ...
              <tbody>
                {displayedEntries.map((agent) => (
                  <tr
                    ...
                    style={agent.isCurrentUser ? { backgroundColor: '#D4FFDE' } : undefined}
                  >
