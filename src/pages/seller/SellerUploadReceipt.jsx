              ...
              {!previewUrl ? (
                <div className="text-left space-y-2 sm:space-y-3">
                  ...
                  <p className="text-slate-600 text-sm sm:text-base">
                    or{' '}
                    <span className="text-blue-600 font-medium cursor-pointer hover:underline" onClick={handleBrowseClick}>
                      click to browse
                    </span>
                  </p>
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 mt-6 sm:mt-8">
              ...
              <button
                ...
                className={`w-full sm:w-auto px-6 sm:px-8 py-2.5 sm:py-3 rounded-xl font-medium text-white flex items-center gap-2 justify-center ${
                  selectedFile ? 'bg-blue-600 hover:bg-blue-700 shadow-sm' : 'bg-blue-300 cursor-not-allowed'
                }`}
              >
                Upload
              </button>
...
export default SellerUploadReceipt;
