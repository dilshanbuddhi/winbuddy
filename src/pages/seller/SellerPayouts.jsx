  ...
  return (
      <div className="p-2 sm:p-6 md:p-8 lg:p-10">
        ...
        <div className="flex justify-between items-start mb-6 md:mb-8">
          <div>
            <h1 className="text-2xl md:text-3xl font-semibold text-slate-900">My Payouts</h1>
        ...
        {/* Summary Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 md:gap-6 mb-8 sm:mb-10 max-w-2xl">
          <div className="bg-white border border-slate-200 rounded-xl p-4 sm:p-6 shadow-sm">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-slate-600 font-medium text-sm sm:text-base">Total Sales</h3>
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-4 sm:p-6 shadow-sm">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-slate-600 font-medium text-sm sm:text-base">Total Commissions</h3>
              <span className="text-green-600 text-xl sm:text-2xl">₹</span>
            </div>
            <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900">
